...
/** The Class Post Book Response Mapper Test. */
@ExtendWith(MockitoExtension.class)
class PostBookResponseMapperTest {

    /** The post book response mapper. */
    @InjectMocks
    PostBookResponseMapperImpl postBookResponseMapper;
    ...
    /**
     * Test to post book v1 response when book is valid then return mapped response.
     */
    @Test
    void testToPostBookV1Response_whenBookIsValid_thenReturnMappedResponse() {
        ...
        assertNotNull(postBookV1Response);
        assertEquals(bookV1Dto, postBookV1Response.getBook());
    }

    /**
     * Test to post book v1 response when book is null then return null.
     */
    @Test
